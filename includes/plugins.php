...
function my_theme_register_required_plugins()
{
    ...
    $plugins = array(
        ...
        array(
            'name' => 'Forms: 3rd-Party Integration',
            'slug' => 'forms-3rdparty-integration',
            'required' => true,
        ),
        array(
            'name' => 'Forms: 3rd-Party Integration',
    ...
    if (is_multisite())
        $plugins[] = array(
            'name' => 'Multisite Toolbar Additions',
            'slug' => 'multisite-toolbar-additions',
            'required' => false,
        );
    // Change this to your theme text domain, used for internationalising strings
    $theme_text_domain = $GLOBALS['sThemeTextDomain'];
